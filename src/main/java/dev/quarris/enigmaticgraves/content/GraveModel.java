...
public class GraveModel extends EntityModel<Entity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition pot = root.addOrReplaceChild("pot", CubeListBuilder.create()
            .texOffs(23, 38).addBox(-3.0F, 2.0F, 4.0F, 3.0F, 3.0F, 1.0F)
            .texOffs(0, 4).addBox(-4.0F, 2.0F, 1.0F, 1.0F, 3.0F, 3.0F)
            .texOffs(0, 0).addBox(-3.0F, 1.0F, 1.0F, 3.0F, 1.0F, 3.0F)
            .texOffs(16, 33).addBox(0.0F, 2.0F, 1.0F, 1.0F, 3.0F, 3.0F)
            .texOffs(39, 29).addBox(-3.0F, 2.0F, 0.0F, 3.0F, 3.0F, 1.0F)
            .texOffs(19, 42).addBox(-3.0F, 3.0F, 1.0F, 3.0F, 1.0F, 3.0F), PartPose.offset(-1.0F, 26.0F, 0.0F));

        PartDefinition sapling_r1 = pot.addOrReplaceChild("sapling_r1", CubeListBuilder.create()
            .texOffs(0, 33).addBox(-4.0F, 7.0F, 0.0F, 8.0F, 8.0F, 0.0F), PartPose.offsetAndRotation(-1.5F, -4.5F, 2.5F, 0.0F, 0.7854F, 0.0F));
        ...
        PartDefinition grave = root.addOrReplaceChild("grave", CubeListBuilder.create()
            .texOffs(0, 0).addBox(-7.0F, -1.0F, -5.0F, 14.0F, 1.0F, 12.0F)
            .texOffs(0, 13).addBox(-7.0F, -1.0F, -7.0F, 14.0F, 14.0F, 2.0F)
            .texOffs(32, 13).addBox(-8.0F, -1.0F, -7.5F, 1.0F, 14.0F, 3.0F)
            .texOffs(0, 29).addBox(-7.0F, 13.0F, -7.5F, 14.0F, 1.0F, 3.0F)
            .texOffs(31, 30).addBox(7.0F, -1.0F, -7.5F, 1.0F, 14.0F, 3.0F)
            .texOffs(0, 52).addBox(-6.0F, 0.0F, -5.0F, 12.0F, 1.0F, 11.0F), PartPose.offset(0.0F, 26.0F, 0.0F));
